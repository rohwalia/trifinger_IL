...
# Location
container_src=$work/container_student.sif
...
wandb_data_dir=$work/.wandb/data_dir_push_image_student
...
singularity exec --containall --writable-tmpfs --nv \
    ...
    $container ./cluster_files/run.sh $@ training.output_dir=$wandb_data_dir policy.teacher_path=$work/.wandb/data_dir_push_image/checkpoints/latest.ckpt policy.edm=$work/.wandb/data_dir_push_image/checkpoints/latest.ckpt
